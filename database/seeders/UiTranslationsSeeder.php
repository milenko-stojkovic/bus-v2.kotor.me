...
class UiTranslationsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $rows = [
            ...
            ['group' => 'panel', 'key' => 'limo_notice_pickup_place', 'locale' => 'en', 'text' => 'the bus stop by the city market'],
            ['group' => 'panel', 'key' => 'limo_notice_pickup_place', 'locale' => 'cg', 'text' => 'autobuskom stajalištu kod gradske pijace'],
            ['group' => 'panel', 'key' => 'limo_notice_p1', 'locale' => 'en', 'text' => 'Agencies that provide limo service must pick up passengers at the designated location — :pickup_link.'],
            ['group' => 'panel', 'key' => 'limo_notice_p1', 'locale' => 'cg', 'text' => 'Agencije koje pružaju uslugu limo servisa imaju obavezu da ukrcavanje putnika vrše na za to predviđenom mjestu — :pickup_link.'],
