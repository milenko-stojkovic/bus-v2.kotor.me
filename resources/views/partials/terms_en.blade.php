<p>By using this service, you agree to abide by all rules and regulations set forth by Kotorbus.</p>
<p>These terms establish the ordering process, payment, and download of the products offered on the bus.kotor.me website.</p>
<p>The bus.kotor.me website is available for private use without any fees and according to the following terms and conditions.</p>
<p>The Vendor is the Municipality of Kotor and the Buyer is the visitor of this website who completes an electronic request, sends it to the Vendor and conducts a payment using a credit or debit card.</p>
<p>The Product is one of the items on offer on the bus.kotor.me website a fee for stopping and parking in a special traffic regulation zone based on the prices established by provisions of the Assembly of the Municipality of Kotor (dependent on bus capacity).</p>
<p>The Buyer orders the product or products by filling an electronic form. Any person who orders at least one product, enters the required information, and sends their order is considered to be a buyer.</p>
