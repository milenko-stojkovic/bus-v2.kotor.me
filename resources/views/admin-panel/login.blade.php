<x-admin-panel-guest-layout page-title="Prijava">
    <div class="max-w-lg mx-auto bg-white shadow-md rounded-lg px-6 py-8">
        <h1 class="text-xl font-semibold text-gray-900 mb-2">Admin panel — prijava</h1>
        <p class="text-sm text-gray-600 mb-6">Glavni operativni panel (odvojeno od Kontrole dolazaka).</p>

        <form method="POST" action="{{ route('panel_admin.login.store', [], false) }}">
            @csrf
            ...
            <div class="block mt-4">
                <label for="remember_me" class="inline-flex items-center">
                    <input id="remember_me" type="checkbox" class="rounded border-red-200 text-red-600 shadow-sm focus:ring-red-500" name="remember" value="1">
